...
'''<summary>
'''     A class of various shared items giving access to in the main static tables
'''     within the sample manager tables
''' </summary>
Namespace Glossary
...
#Region "Shared"
      ...
      Public Shared Function OptionGroups(ByVal GroupName As String) As Groups._OptionRow()
        ...
        ''' </history>
        ''' -----------------------------------------------------------------------------
        Public Shared Property AddressTypes() As MedscreenLib.Glossary.AddressTypes
            Get
                If oAddressType Is Nothing Then
                    oAddressType = New MedscreenLib.Glossary.AddressTypes()
                    oAddressType.Load()
                End If
                Return oAddressType
            End Get
            Set(ByVal Value As MedscreenLib.Glossary.AddressTypes)
                oAddressType = Value
            End Set
        End Property
...
#Region "Personnel"
        ...
        Public Shared Function CurrentSMUser() As MedscreenLib.personnel.UserPerson
            ...
            Dim up As MedscreenLib.personnel.UserPerson = _
                Personnel.Item(System.Security.Principal.WindowsIdentity.GetCurrent.Name, _
...
#Region "Collections"
        ...
        Public Shared ReadOnly Property ReasonForTestList() As MedscreenLib.Glossary.PhraseCollection
            Get
                Dim myPhrase As PhraseCollection = PhraseList.Item("COLL_TYPE")
        ...
        Public Shared Property Menus() As MedscreenLib.CRMenuItems
            Get
                If myMenus Is Nothing Then
                    ...
                    myMenus.Load(CConnection.DbConnection)
...
#Region "Functions"
        ...
        Public Function ToXml() As String
            ...
            Dim strRet As String = "<?xml version='1.0'?><" & strPhraseType & ">"
            For i = 0 To Me.Count - 1
                objItem = Me.Item(i)
        ...
        ''' </history>
        ''' -----------------------------------------------------------------------------
        Public Function Add(ByVal Item As Phrase) As Integer
        ...
        ''' </history>
        ''' -----------------------------------------------------------------------------
        Public Function IndexOf(ByVal Phrase As String) As Integer
            Dim i As Integer
...
#Region "Procedures"
        ...
        ''' </revisionHistory>
        ''' 
        Public Sub New(ByVal From As String, ByVal BuildUsing As BuildBy, Optional ByVal WhereClause As String = "")
                    ...
                    Try
                        ...
                        If CConnection.ConnOpen Then            'Attempt to open reader
                            ...
                            While oRead.Read                    'Loop through data
                                ...
                                objPhrase.PhraseID = strId
                                objPhrase.PhraseText = strDescription
...
#Region "Properties"
        ...
        ''' </history>
        ''' -----------------------------------------------------------------------------
        Default Public Overloads Property Item(ByVal Index As Integer) As Phrase
            Get
                Return CType(Me.List.Item(Index), Phrase)
            End Get
        ...
        ''' </history>
        ''' -----------------------------------------------------------------------------
        Default Public Overloads Property Item(ByVal Index As String) As Phrase
            Get
                Dim I As Integer
                Dim objPhrase As Phrase
...
#Region "Properties"
  ...
  Default Public ReadOnly Property Item(ByVal index As String) As PhraseCollection
    Get
      Dim i As Integer
      Dim objPhrColl As PhraseCollection
  ...
  Public Sub New()
    ...
    Try
      ...
      While oRead.Read
        ...
        objCurr = New Currency(Me.objCurrencyId.Value)
        Me.Add(objCurr)
        objCurr.Fields = Me.myFields
...
#Region "Functions"
  ...
  ''' </history>
  ''' -----------------------------------------------------------------------------
  Public Function Convert(ByVal InputCurrency As String, ByVal outputCurrency As String, _
...
#Region "Functions"
  ...
  Public Function Load()
    ...
    If blnLoaded = True Then Exit Function
    Try
...
#Region "Function"
  ...
  ''' </history>
  ''' -----------------------------------------------------------------------------
  Public Function Add(ByVal Item As AddressType) As Integer
    Return MyBase.List.Add(Item)
  End Function
  ...
  Public Function Load() As Boolean
    ...
    Try
      ...
      oRead = oCmd.ExecuteReader
      While oRead.Read
        Dim oAT As AddressType = New AddressType()
...
#Region "Properties"
  ...
  ''' </history>
  ''' -----------------------------------------------------------------------------
  Default Public Property Item(ByVal index As Integer) As AddressType
    Get
      Return CType(MyBase.List.Item(index), AddressType)
    End Get
...
#Region "Declarations"
        ...
        Private objLogicalName As StringField = New StringField("LOGICAL_NAME", "", 234)
        Private objDeviceType As StringField = New StringField("DEVICE_TYPE", "", 10)
        Private objModifiedOn As TimeStampField = New TimeStampField("MODIFIED_ON")
        Private objModifiedBy As UserField = New UserField("MODIFIED_BY")
        Private objModifiable As BooleanField = New BooleanField("MODIFIABLE", "")
        Private objRemoveflag As BooleanField = New BooleanField("REMOVEFLAG", "")
        Private objDeviceName As StringField = New StringField("DEVICE_NAME", "", 20)
        Private objPrinterCodeType As StringField = New StringField("PRINTER_CODE_TYPE", "", 20)
        Private objPrinterParameter As StringField = New StringField("PRINTER_PARAMETER", "", 234)
        Private objGraphicsType As StringField = New StringField("GRAPHICS_TYPE", "", 10)
#End Region
...
#Region "Procedures"
        Public Sub New()
            ...
            MyBase.Fields.Add(objGroupId)
            MyBase.Fields.Add(objDescription)
            MyBase.Fields.Add(objLocation)
            MyBase.Fields.Add(objLogicalName)
            MyBase.Fields.Add(objDeviceType)
            MyBase.Fields.Add(objModifiedOn)
            MyBase.Fields.Add(objModifiedBy)
            MyBase.Fields.Add(objModifiable)
            MyBase.Fields.Add(objRemoveflag)
            MyBase.Fields.Add(objDeviceName)
            MyBase.Fields.Add(objPrinterCodeType)
            MyBase.Fields.Add(objPrinterParameter)
            MyBase.Fields.Add(objGraphicsType)
        End Sub
#End Region
#Region "Properties"
        ...
        Public Property LogicalName() As String
            Get
                Return objLogicalName.Value
            End Get
            Set(ByVal Value As String)
                objLogicalName.Value = Value
            End Set
        End Property
        ...
        Public Property DeviceType() As String
            Get
                Return objDeviceType.Value
            End Get
            Set(ByVal Value As String)
                objDeviceType.Value = Value
            End Set
        End Property
        ...
        Public Property Modifiable() As Boolean
            Get
                Return objModifiable.Value
            End Get
            Set(ByVal Value As Boolean)
                objModifiable.Value = Value
            End Set
        End Property
        ...
        ''' </remarks>
        ''' <revisionHistory>
        ''' <revision><Author>[taylor]</Author><date> [17/01/2007]</date><Action></Action></revision>
        ''' </revisionHistory>
        ''' -----------------------------------------------------------------------------
        Public Property DeviceName() As String
            Get
                Return objDeviceName.Value
            End Get
            Set(ByVal Value As String)
                objDeviceName.Value = Value
            End Set
        End Property
        ...
        Public Property PrinterCodeType() As String
            Get
                Return objPrinterCodeType.Value
            End Get
            Set(ByVal Value As String)
                objPrinterCodeType.Value = Value
            End Set
        End Property
        ...
        Public Property PrinterParameter() As String
            Get
                Return objPrinterParameter.Value
            End Get
            Set(ByVal Value As String)
                objPrinterParameter.Value = Value
            End Set
        End Property
        ...
        Public Property GraphicsType() As String
            Get
                Return objGraphicsType.Value
            End Get
            Set(ByVal Value As String)
                objGraphicsType.Value = Value
            End Set
        End Property
...
#Region "Properties"
        ...
        ''' -----------------------------------------------------------------------------
        ''' <summary>
        ''' Get a printer by position in list 
        ''' </summary>
        ''' <param name="index">Position of printer</param>
        ''' <value></value>
        ''' <remarks>
        ''' </remarks>
        ''' <revisionHistory>
        ...
        ''' </revisionHistory>
        ''' -----------------------------------------------------------------------------
        Default Public Overloads Property Item(ByVal index As Integer) As Printer
            Get
                Return CType(MyBase.List.Item(index), Printer)
            End Get
        ...
        ''' </revisionHistory>
        ''' -----------------------------------------------------------------------------
        Default Public Overloads Property Item(ByVal index As String) As Printer
            Get
                Dim objPrinter As Printer
                For Each objPrinter In MyBase.List          'Go through all printers
                    If objPrinter.Identity = index Then     'Found printer
                        Exit For
                    End If
                    objPrinter = Nothing            'Reset object 
                Next
                Return objPrinter
            End Get
            Set(ByVal Value As Printer)
...
#Region "Functions"
        ''' -----------------------------------------------------------------------------
        ''' <summary>
        ''' Add a printer to the collection 
        ''' </summary>
        ''' <param name="item"></param>
        ''' <returns></returns>
        ''' <remarks>
        ...
        ''' </revisionHistory>
        ''' -----------------------------------------------------------------------------
        Public Function Add(ByVal item As Printer) As Integer
            Return MyBase.List.Add(item)
        End Function
        ...
        Public Function Load() As Boolean
            ...
            oCmd.CommandText = MyBase.Fields.FullRowSelect & " Where removeflag = 'F'"
            Try
                oCmd.Connection = CConnection.DbConnection
                If CConnection.ConnOpen Then            'Attempt to open reader
                    oRead = ocmd.ExecuteReader          'Get Date
                    While oRead.Read                    'Loop through data
                        ...
                        objPrinter.DataFields.readfields(oRead)
                        Me.Add(objPrinter)
                    End While
                End If
                blnRet = True
            Catch ex As Exception
                LogError(ex, , "Loading printer collection")
            Finally
                CConnection.SetConnClosed()             'Close connection
                If Not oRead Is Nothing Then            'Try and close reader
                    If Not oRead.IsClosed Then oRead.Close()
...
#Region "Procedures"
        ...
        Public Sub New(ByVal Analysis As String, ByVal orderNumber As Integer)
            ...
            Me.Fields.Load(MedscreenLib.CConnection.DbConnection, "analysis = ?  and order_number = ?", pcoll)
        End Sub
...
#Region "Functions"
        ...
        Public Function Load() As Boolean
            ...
            Try
                oCmd.Connection = CConnection.DbConnection          ' set up command object 
...
#Region "Functions"
        ...
        Public Function Insert() As Boolean
            Return Me.Fields.Insert(CConnection.DbConnection)
        End Function

        Public Function Update() As Boolean
            Return Me.Fields.Update(CConnection.DbConnection)
        End Function
        ...
        ''' </revisionHistory>
        ''' -----------------------------------------------------------------------------
        Public Function FullDescription() As String
...
#Region "Properties"
        ...
        Default Public Property Item(ByVal index As Integer, Optional ByVal opt As Integer = 0) As DiscountScheme
            Get
                If opt = 0 Then
                    Return CType(MyBase.List.Item(index), DiscountScheme)
                ElseIf opt = 1 Then
                    Dim i As Integer
                    Dim ds As DiscountScheme
                    For i = 0 To Me.Count - 1
...
#Region "Declarations"
        ...
        Private objType As StringField = New StringField("TYPE", "", 10)
        Private objApplyTo As StringField = New StringField("APPLYTO", "", 10)
...
#Region "Functions"
        ...
        Public Function ToXmlExample(ByVal CurrencyCode As String, ByVal CustomerID As String) As String
            ...
            Dim minChargeDiscount As Object
            Dim SampleDiscount As Object
            ...
            ElseIf Me.Type = "VESSEL" Then
                ocmd = New OleDb.OleDbCommand("Select name from vessel where vessel_id = '" & Me.ApplyTo.Trim & "'", CConnection.DbConnection)
...
#Region "Properties"
        ...
        Default Public Overloads Property Item(ByVal index As Integer, ByVal opt As IndexBy) As VolumeDiscountHeader
            Get
                Dim oVDH As VolumeDiscountHeader
            ...
            Try
                ...
                If myForm.ShowDialog = DialogResult.OK Then
                    With myForm._Option
                        ...
                        Me.Fields.Update(CConnection.DbConnection)
                    End With
                    myReturn = True
                End If
            Catch ex As Exception
    ...
    Public Class OptionCollection
        ...
        Public Function Load() As Boolean
            ...
            Try
                ...
                oCmd.Connection = CConnection.DbConnection
                oCmd.CommandText = Me.myFields.FullRowSelect
                CConnection.SetConnOpen()
...
Public Class IndustryDefaultCollection
  ...
  Default Public Overloads Property Item(ByVal index As String) As IndustryDefault
    Get
      Dim oIndDef As IndustryDefault
