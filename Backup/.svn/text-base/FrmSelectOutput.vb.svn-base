...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmOutputSelect))
        ...
        'cbOption
        '
        'Me.cbOption.Items.AddRange(New Object() {cstEMAILOption, cstPDFOption, cstFaxOption, cstPrinterOption})
        ...
        Me.Controls.AddRange(New System.Windows.Forms.Control() {Me.Panel1, Me.CBInstalledPrinters, Me.txtDestination, Me.Label2, Me.cbOption, Me.Label1})
...
#End Region
    ...
    Private Sub cbOption_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbOption.SelectedIndexChanged
        ...
        Else
            ...
            ' 
            If Me.cbOption.Text = Me.cstEMAILOption Then
            ...
            ElseIf Me.cbOption.Text = Me.cstFaxOption Then
            ...
            ElseIf Me.cbOption.Text = Me.cstPDFOption Then
