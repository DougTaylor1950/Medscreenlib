...
#Region "Functions"
        ...
        Public Function ReadString(ByRef strSection As String, ByRef strItem As String, ByRef strDefault As String) As String
            ...
            Try
                ...
                If ilen > 0 Then
                    ReadString = Left(Buffer, ilen)
                Else
                    ReadString = strDefault
                End If
...
Namespace Support
    Module modSupport
        ...
        'Public Property DbLiveConnection() As OleDb.OleDbConnection
        '    Get
        '        If MyLiveConn Is Nothing Then
        '            MyLiveConn = New OleDb.OleDbConnection()
        '            MyLiveConn.ConnectionString = ConnectString(6)
        '        End If
        '        Return MyLiveConn
        '    End Get
        ...
        'Public Sub SetLiveConnOpen()
        '    If MyLiveConn.State = ConnectionState.Closed Then
        '        MyLiveConn.Open()
        '    End If

        'End Sub

        'Public Sub SetLiveConnClosed()
        '    MyLiveConn.Close()

        'End Sub

        Public Overloads ReadOnly Property ConnectString(ByVal intOpt As Integer, _
             Optional ByVal blnUseProvider As Boolean = True) As String
            Get
                Dim strRet As String = ""

                If strStatus = STATUS_TEST Then
                    If intOpt = 6 Then intOpt = 5
                    If intOpt = 7 Then intOpt = 8

                End If
                '"Data Source=[Input Oracle Nile Data Source];Pooling=true;User ID=NILE3;Password=NILE3";
                If intOpt = 5 Then
                    If blnUseProvider Then
                        strRet = "Provider=" & CConnection.DBProvider() & ";"
                    End If
                    strRet += "Data Source=John-dev;Pooling=true;" & _
                        "User ID=dev" & _
                        ";Password=Dev"
                    Return strRet
                ...
                ElseIf intOpt = 6 Then
                    If blnUseProvider Then
                        strRet = "Provider=" & CConnection.DBProvider() & ";"
                    End If
                    strRet += "Data Source=John-live;Pooling=true;" & _
                        "User ID=live" & _
                        ";Password=live"
                    Return strRet
                ElseIf intOpt = 7 Then
                    If blnUseProvider Then
                        strRet = "Provider=" & CConnection.DBProvider() & ";"
                    End If
                    strRet += "Data Source=John-orcl;Pooling=true;" & _
                        "User ID=onestop" & _
                        ";Password=onestop"
                    Return strRet
                ElseIf intOpt = 8 Then
                    If blnUseProvider Then
                        strRet = "Provider=" & CConnection.DBProvider() & ";"
                    End If
                    strRet += "Data Source=John-orcl;Pooling=true;" & _
                        "User ID=onestoptest" & _
                        ";Password=onestop"
                    Return strRet

                Else
          Return MedConnection.Connection.ConnectionString
          '"Data Source=" & CConnection.DBDatabase() & ";Pooling=true;" & _
          '                       "User ID=" & CConnection.DBUserName() & _
          '                       ";Password=" & CConnection.DBPassword()
                End If
            End Get
        End Property
