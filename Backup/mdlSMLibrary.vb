...
#Region "Instance"
  ...
  ''' </summary>
  ''' <param name="name"></param>
  ''' <param name="provider"><b>N.B.<b/>If empty string or Nothing, defaults to MSDORA.1</param>
    ...
    Public ReadOnly Property ServerPath() As String
        Get
            ...
            If _path Is Nothing Then
                ...
                getPath.Parameters.Add("Config_ID", "SYSTEM_ROOT_PATH")
                Try
    ...
    Get
      ...
      If Not keyIndex Is Nothing Then
        ...
        If TypeOf index Is Integer Then
          Return MyBase.List.Item(CInt(index))
        End If
      End If
    End Get
  End Property
