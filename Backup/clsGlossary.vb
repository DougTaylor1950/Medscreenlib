...
#Region "Functions "
      ...
      End Function
        ...
        Public Shared Function UserHasRole(ByVal RoleName As String) As Boolean
            Dim UP As MedscreenLib.personnel.UserPerson = CurrentSMUser()
            ...
            If strRet.Trim.Length = 0 Then strRet = "0"
...
#Region "Properties"
        ...
        Protected Friend Function SetPhraseID(ByVal value As String)
            objPhraseId.Value = value
        End Function

        Protected Friend Function SetPhraseText(ByVal value As String)
            objPhraseText.Value = value
        End Function
...
#Region "Functions"
    ...
    ''' </history>
    ''' -----------------------------------------------------------------------------
    Public Function ToArray() As Phrase()
      Return DirectCast(Me.InnerList.ToArray(GetType(Phrase)), Phrase())
    End Function
    ...
    ''' </history>
    ''' -----------------------------------------------------------------------------
        Public Function IndexOf(ByVal Phrase As String, Optional ByVal by As IndexBy = IndexBy.PhraseId) As Integer
            Dim i As Integer
...
#Region "Procedures"
        ...
        Public Sub New()
            ...
            Try
                ...
                oRead = oCmd.ExecuteReader
                While oRead.Read
                    Dim strID = oRead.GetValue(oRead.GetOrdinal("CURRENCYID"))
    ...
    ''' -----------------------------------------------------------------------------
        ...
        Public Function FullDescription(Optional ByVal Customer As String = "") As String
            ...
            If Customer.Trim.Length > 0 Then
                ...
                Dim strResp = CConnection.PackageStringList("pckwarehouse.getdiscounttext", ocoll)
                strRet += strResp
                Return strRet
                Exit Function
            End If
