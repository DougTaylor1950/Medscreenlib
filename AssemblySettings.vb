...
#Region "Shared"
    ...
    Public Overloads Shared Function GetConfig(ByVal asm As [Assembly], ByVal sectionName As String) As IDictionary
        ...
        Try
            ...
            If Mid(cfgFile, 1, 8) = "file:///" Then cfgFile = Mid(cfgFile, 9)
            If IO.File.Exists(cfgFile) Then                 'If file exists then fine 
                doc.Load(New XmlTextReader(cfgFile))
            Else                                            'Otherwise load from default location 
                Dim FileName As String = IO.Path.GetFileName(cfgFile)
                FileName = MedscreenLib.Constants.GCST_X_DRIVE & "\IT\Config\" & FileName
