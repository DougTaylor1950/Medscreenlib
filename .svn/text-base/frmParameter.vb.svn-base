...
#End Region
        ...
        Get
            Select Case Me.MyType
                ...
                Case Medscreen.MyTypes.typItem
                    If cmbOption.DataSource Is Nothing Then
                        Return Me.cmbOption.Text
                    Else
                        Return Me.cmbOption.SelectedValue
                    End If

                Case Medscreen.MyTypes.File
    ...
    Private Sub frmParameter_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
        If MyType = Medscreen.MyTypes.File Then
    ...
    Public WriteOnly Property PhraseList() As Glossary.PhraseCollection
        Set(ByVal Value As Glossary.PhraseCollection)
            Me.cmbOption.Items.Clear()
            Me.cmbOption.DataSource = Value
            Me.cmbOption.DisplayMember = "PhraseText"
            Me.cmbOption.ValueMember = "PhraseId"
        End Set
    End Property
